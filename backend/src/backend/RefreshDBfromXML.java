...
public class RefreshDBfromXML  {
	 public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException {
	        ...
	        try (Connection connection = DriverManager.getConnection("cd jdbc:postgresql://localhost:5432/soni","postgres", "qwerty123")) {
	            ...
	            File inputFile = new File("C:\\Users\\sonip\\NCP\\BugFixingApp\\backend\\src\\sampledb.xml");
